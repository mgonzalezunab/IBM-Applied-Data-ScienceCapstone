...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(id='payload-slider',min=0, max=10000, step=1000,
                                    marks={0: '0',2500: '2500',5000:"5000",7500:"7500"},value=[min_payload, max_payload]
                                ),
...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        filtered_df = spacex_df[spacex_df["Launch Site"]==entered_site].groupby("class").count().reset_index().rename(columns={'Unnamed: 0':'Total'})
        fig = px.pie(filtered_df, values='Total', 
        names='class', 
        title='Total Success Launches for the site')
        return fig
